import type {HierarchyConfig, HierarchyNode, MirrorNode, NamingStrategy, NodeKind, QueryNode, SafeDeleteMode, StaticNode,} from '@/lib/types'
...
/** Empty config matching the server's normalized default (§4.1). */
